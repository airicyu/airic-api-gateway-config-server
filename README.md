...
```
POST http://localhost:3001/keys/id-key
Content-type: application/json
id-key: {{adminToken}}
...
```
POST http://localhost:3001/keys/id-key/verification
Content-type: application/json
...
```
POST http://localhost:3001/keys/api-key
Content-type: application/json
id-key: {{adminToken}}
...
### Verify API key
```
POST http://localhost:3001/keys/api-key/verification
Content-type: application/json
